...
import board from '../assets/real-board.jpg';
...
const imageData = [
    ...
    {
        label: "Sipder-Man",
        alt: "Cover for Marvel's Spider-Man",
        url: spider
    },
];
...
export default function About() {
    ...
    return (
        <section className="about">
            ...
            <h4>Introduction</h4>
            <p>I am Ibrahima Barry and I am a Full Stack Developer based in Maryland.</p>
            ...
            <p>With most of my interests lying in Science Fiction, I enjoy media that depicts advanced societies or places where superpowers are common. Some of these
                include:
            </p>
